  ...
  <div class="container">
    ...
    <main>
      ...
      <div class="content">
        ...
        <h2>2. Hosting</h2>
        <h3>Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</h3>

        <h3>IONOS</h3>
        <p>
          Anbieter ist die IONOS SE, Elgendorfer Str. 57, 56410 Montabaur (nachfolgend IONOS). Wenn Sie unsere Website besuchen, erfasst IONOS verschiedene Logfiles inklusive Ihrer IP-Adressen. Details entnehmen Sie der Datenschutzerklärung von IONOS: <a href="https://www.ionos.de/terms-gtc/terms-privacy" target="_blank">https://www.ionos.de/terms-gtc/terms-privacy</a>.
        </p>
        <p>
        ...
        <p>
          ...
          E-Mail: <a href="mailto:info@mz24.net">info@mz24.net</a>
        </p>
        <p>
...
/* Inhalt linksbündig wie im Impressum */
.content {
  text-align: left;
}
